...
//    public static String city="shanghai";
    ...
    public boolean shouldVisit(Page referringPage, WebURL url) {
        ...
        return !FILTERS.matcher(href).matches()
                && (href.indexOf("baixing.com/zhenghun/") !=-1 || href.indexOf("baixing.com/nanzhaov/") !=-1 || href.indexOf("baixing.com/juhui/") !=-1) ;
//
//        return !FILTERS.matcher(href).matches()
//                && (href.startsWith("http://shanghai.baixing.com/zhenghun/a1604090682.html?from=regular")) ;
    }
